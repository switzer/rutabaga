var sys = require("sys"),
    ...
    Config = require("../conf/settings").DefaultConfig,
...
var _root = path.join(path.dirname(__filename), "..");
var schema = new Schema(fs.readFileSync(path.join(_root, './proto/openx.desc')));
